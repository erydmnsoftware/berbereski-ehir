    ...
    <div className="space-y-6 pb-12 w-full max-w-full overflow-hidden relative">
      ...
      >
        <div className="grid border-b border-[#333] sticky top-0 z-30 bg-[#111111]/95 backdrop-blur-md"
          ...
          <div className="p-4 text-xs font-bold uppercase tracking-widest text-[#888] flex items-center justify-center border-r border-[#222]">
            Saat
          </div>
          {barbers?.map((barber) => (
        ...
        <div ref={scrollRef} className="overflow-y-auto max-h-[calc(100vh-280px)] relative scrollbar-thin scrollbar-thumb-[#444] scrollbar-track-[#111]" style={{ touchAction: 'pan-y' }}>
          {showTimeIndicator && (
            ...
            >
              <div className="w-20 text-right pr-2 text-xs font-bold text-red-500 bg-[#111] py-1">
          ...
          <div className="relative">
            {TIME_SLOTS.map((timeSlot) => (
              ...
              >
                ...
                <div className="text-xs font-medium text-[#666] border-r border-[#222] flex items-start justify-center pt-2 bg-[#161616]">
                  {timeSlot}
                </div>
                        ...
                        {barberAppts.map((appt) => {
                          ...
                          return (
                            <motion.div
                              ...
                              drag="y"
                              dragConstraints={{ top: -1000, bottom: 1000 }} // Sınırları kaldırıp serbestlik sağladık
                              dragElastic={0.2} // Daha esnek ve hızlı bir sürükleme hissiyatı
                              dragMomentum={false}
                              onDragEnd={(e, info) => {
                                const yOffset = info.offset.y;
                                if (Math.abs(yOffset) > 15) { // Sadece belirgin sürüklemelerde saati değiştir
